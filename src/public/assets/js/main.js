(function ($) {
  ...
  (function () {
    ...
    $offCanvasToggle.on("click", function (e) {
      ...
      const urlAddCart =
        location.protocol + "//" + location.host + "/cart/get-all";
      $.ajax({
        url: urlAddCart,
        method: "get",
        dataType: "json",
        ...
        let appendCode = "";
        res.cart.items.forEach(function (e) {
          appendCode += `
                    ...
                    <div class="offcanvas-cart-item-content">
                        ...
                        <span class="offcanvas-cart-item-details-price">${formatter.format(
                          e.productId.price.$numberDecimal
                        )}</span>
                        </div>
                    </div>
                    </div>
                    <div class="offcanvas-cart-item-delete text-right">
                    <a href="#" class="offcanvas-cart-item-delete" data-del="${
                      e._id
                    }"
            ...
            `;
          $("#parent-cart-offcanvas").html(appendCode);
          $("#Subtotal").html(formatter.format(res.cart.totalCost));
        });
      });
